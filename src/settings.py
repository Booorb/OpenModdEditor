                ...
                with dpg.menu_bar():
                    if os.path.isfile(gameFolder + "/taro2/src/game.json"):
                        with dpg.menu(label="General"):
                            with open(gameFolder + "/taro2/src/game.json") as f:
                                ...
                                if "gameSlug" in data.keys():
                                    dpg.set_value(
                                        value=data["gameSlug"], item="game_slug"
                                    )
                                else:
                        ...
                        with dpg.menu(label="Engine"):
                            ...
                            if "physicsEngine" in data.keys():
                                if data["physicsEngine"] == "planck":
                                    dpg.set_value(
                                        value="PlanckJS", item="physics_engine"
                                    )
                                elif data["physicsEngine"] == "box2dweb":
                                    dpg.set_value(
                                        value="Box2dWeb", item="physics_engine"
                                    )
                                else:
                                    dpg.set_value(
                                        value="Box2d es6", item="physics_engine"
                                    )
                            ...
                            if "renderingFilter" in data.keys():
                                if data["renderingFilter"] == "smooth":
                                    dpg.set_value(
                                        value="Smooth", item="rendering_filter"
                                    )
                                else:
                                    dpg.set_value(
                            ...
                            dpg.add_slider_int(
                                label="x", default_value=0, tag="gravity_x"
                            )
                            dpg.add_slider_int(
                                label="y", default_value=0, tag="gravity_y"
                            )
                        ...
                        with dpg.menu(label="UI"):
                            ...
                            if (
                                "trackingDelay"
                                in data["data"]["settings"]["camera"].keys()
                            ):
                                dpg.add_slider_int(
                                    default_value=data["data"]["settings"]["camera"][
                                        "trackingDelay"
                            ...
                            dpg.add_text(
                                "Add stroke to name labels and attribute bars:"
                            )
                            if (
                                "addStrokeToNameAndAttributes"
                                in data["data"]["settings"].keys()
                                and data["data"]["settings"][
                                    "addStrokeToNameAndAttributes"
                                ]
                                is not None
                            ):
                        ...
                        with dpg.menu(label="Title Screen"):
                            ...
                            if "twitterLink" in data.keys():
                                dpg.add_input_text(
                                    default_value=data["twitterLink"],
                                    tag="twitter_link",
                                )
                            else:
                            ...
                            if "facebookLink" in data.keys():
                                dpg.add_input_text(
                                    default_value=data["facebookLink"],
                                    tag="facebook_link",
                                )
                            else:
                            ...
                            if "youtubeLink" in data.keys():
                                dpg.add_input_text(
                                    default_value=data["youtubeLink"],
                                    tag="youtube_link",
                                )
                            else:
                            ...
                            if (
                                ...
                                dpg.add_checkbox(
                                    default_value=data["moreIoGames"],
                                    tag="iogames_link",
                                )
                            else:
                        ...
                        with dpg.menu(label="Mod/Lobby"):
                            ...
                            if (
                                ...
                                dpg.add_checkbox(
                                    default_value=data["isLobbyEnabled"],
                                    tag="enable_lobby",
                                )
                            else:
