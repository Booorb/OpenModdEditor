...
class EditThemePlugin:
    ...
    def createTheme(self):
        with dpg.theme_component(dpg.mvAll, parent="glob"):
            self.parse_color_operation(
                'dpg.add_theme_color(dpg.[VARGOESHERE],		self.getThemeColor("[VARGOESHERE]"),			category=dpg.mvThemeCat_Core)'
            )
        dpg.bind_theme("glob")
    ...
    def createDefaultTheme(self):
        ...
        self.confParser["Theme"][
            "mvthemecol_text"
        ] = "255.0, 254.99607849121094, 254.99607849121094, 255.0"
        self.confParser["Theme"][
            "mvthemecol_tabactive"
        ] = "177.51373291015625, 26.478431701660156, 26.48627471923828, 255.0"
        self.confParser["Theme"][
            "mvthemecol_slidergrabactive"
        ] = "249.0, 66.0, 72.062744140625, 255.0"
        self.confParser["Theme"][
            "mvthemecol_textdisabled"
        ] = "127.0, 127.0, 127.0, 255.0"
        self.confParser["Theme"][
            "mvthemecol_tabunfocused"
        ] = "53.53333282470703, 22.77254867553711, 22.776470184326172, 247.0"
        self.confParser["Theme"][
            "mvthemecol_button"
        ] = "123.97647094726562, 0.6823529601097107, 0.6901960968971252, 255.0"
        self.confParser["Theme"][
            "mvthemecol_windowbg"
        ] = "12.678431510925293, 12.607843399047852, 12.607843399047852, 239.0"
        self.confParser["Theme"][
            "mvthemecol_tabunfocusedactive"
        ] = "107.0, 35.0, 35.00392150878906, 255.0"
        self.confParser["Theme"][
            "mvthemecol_buttonhovered"
        ] = "231.04705810546875, 17.870588302612305, 24.937253952026367, 255.0"
        self.confParser["Theme"][
            "mvthemecol_childbg"
        ] = "0.0, 0.0, 0.0, 26.764705657958984"
        self.confParser["Theme"][
            "mvthemecol_dockingpreview"
        ] = "249.0, 66.0, 66.00784301757812, 178.0"
        self.confParser["Theme"][
            "mvthemecol_buttonactive"
        ] = "249.0, 15.0, 15.011764526367188, 255.0"
        ...
        self.confParser["Theme"][
            "mvthemecol_header"
        ] = "249.0, 66.0, 66.00784301757812, 79.0"
        ...
        ] = "236.68235778808594, 36.61176300048828, 36.62352752685547, 242.0"
        ...
        ] = "255.0, 255.0, 255.0, 178.0"
        self.confParser["Theme"][
            "mvthemecol_checkmark"
        ] = "249.0, 66.0, 66.00784301757812, 255.0"
        self.confParser["Theme"][
            "mvthemecol_navwindowingdimbg"
        ] = "204.0, 204.0, 204.0, 51.0"
        self.confParser["Theme"][
            "mvthemecol_slidergrab"
        ] = "224.0, 60.99607849121094, 61.007843017578125, 255.0"
        self.confParser["Theme"][
            "mvthemecol_modalwindowdimbg"
        ] = "204.0, 204.0, 204.0, 89.0"
